...
def get_config():
    ...
    parser.add_argument("--comm_view", type=float, default=2.0)
    parser.add_argument("--collision_distance", type=float, default=0.08)
    parser.add_argument("--collision_reward", type=float, default=-1)
    parser.add_argument("--catch_distance", type=float, default=0.12)
