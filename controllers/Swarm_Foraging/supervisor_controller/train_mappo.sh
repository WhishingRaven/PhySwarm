...
while [ "$seed" -le "$seed_max" ]; do
    ...
    --episode_length 1000 --use_soft_update  --hard_update_interval_episode 2000 --num_env_steps 2000000 --n_training_threads 8 \
    --msg_iterations 4  --adj_output_dim 32  --eval_interval 100000 --num_eval_episodes 60 --buffer_size 32 --num_mini_batch 4 --log_interval 2400 --save_interval 50000 \
    ...
    --n_rollout_threads 1 --num_agents 8 --num_target 2 --model_dir ../models/ "$@"
    seed=$((seed + 1))
done
