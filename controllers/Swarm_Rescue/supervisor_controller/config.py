...
def get_config():
    ...
    parser.add_argument("--comm_view", type=float, default=0.6)
    parser.add_argument("--collision_distance", type=float, default=0.12)
    parser.add_argument("--collision_reward", type=float, default=-1)
    parser.add_argument("--catch_distance", type=float, default=0.15)
    ...
    # forge parameters example
    # parser.add_argument("--obs_view", type=float, default=0.5)
    # parser.add_argument("--comm_view", type=float, default=0.4)
    # parser.add_argument("--catch_distance", type=float, default=0.15)
