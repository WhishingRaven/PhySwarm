"""Rescue physics-regularized MAPPO update strategy."""
...
class R_MAPPO:
    ...
    def _calculate_pinn_loss(self, obs_batch, pde_params, active_masks):
        ...
        # 두 행뿐인 ridge 문제를 backend decomposition 없이 푼다.
    ...
    def _torch_map_actions_to_params(self, raw_action_batch):
        """runtime과 동일한 6채널 legacy projection을 미분 가능하게 적용한다."""

        projected = project_torch_parameters(
            to_torch(raw_action_batch), PARAMETER_LAYOUT
        )
