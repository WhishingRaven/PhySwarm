...
import torch
import time
from learning.rollout_context import record_physics_transition
from learning.rmappo.runner import RecurrentRunner
from learning.rmappo.utils import make_onehot

class SwarmRolloutRunner(RecurrentRunner):
    ...
    def collect_rollout(self, explore=True, training_episode=True, warmup=False):
        ...
        # 정확한 physics loss는 actor observation과 분리된 transition payload를 쓴다.
        episode_physics = {p_id: {}}
        ...
        if explore:
            ...
            idx = self.buffer.insert(self.num_envs, episode_obs, episode_share_obs, episode_acts, episode_prob_acts,
                                  ...
                                  physics_context=episode_physics if episode_physics[p_id] else None)
