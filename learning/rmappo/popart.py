...
"""PopArt value-output normalization layer."""
...
class PopArt(nn.Module):
    ...
    def __init__(self, input_shape, device=torch.device("cpu"), norm_axes=1, beta=0.99999, per_element_update=False, epsilon=1e-5):
    ...
    def forward(self, input_vector, train=True):
        ...
        if train:
            ...
            if len(detached_input.shape) >2 :
                detached_input = detached_input.reshape(-1,1)
